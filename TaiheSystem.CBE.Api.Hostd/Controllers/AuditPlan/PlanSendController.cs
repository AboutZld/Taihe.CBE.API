...
namespace TaiheSystem.CBE.Api.Hostd.Controllers.Basic
{
    ...
    [ApiController]
    public class PlanSendController : BaseController
    {
        /// <summary>
        /// 日志管理接口
        /// </summary>
        private readonly ILogger<PlanSendController> _logger;
        /// <summary>
        /// 会话管理接口
        /// </summary>
