...
namespace TaiheSystem.CBE.Api.Model.Dto
{
    ...
    /// 资料回收确认
    /// </summary>
    public class EvaluationDto : PageParm
    {

        /// <summary>
        /// 描述 : 状态 0-未评定 1- 待整改 2-已整改 3-评定未通过 4-评定通过
        /// 空值 : False
        /// 默认 : 
        /// </summary>
        [Display(Name = "状态")]
    ...
    public class EvaluationProblemDto
    {
        ...
        /// </summary>
        [Display(Name = "评定问题列表")]
        public List<Biz_Contract_Plan_EvaluationProblem> EvaluationProblemList { get; set; }
