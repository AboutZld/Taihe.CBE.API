...
namespace TaiheSystem.CBE.Api.Model.Dto
{
    ...
    /// 查询合同登记
    /// </summary>
    public class MainContractQueryDto : PageParm
    {
    ...
    /// 合同添加模块
    /// </summary>
    public class MainContractCreateDto
    {
        ...
        /// </summary>
        [Display(Name = "合同体系项目列表")]
        public List<ContractItemVM> ContractItemList_insert;
        ...
        /// 默认 : 
        /// </summary>
        [Display(Name = "合同分场所信息(插入)")]
        public List<FcsVM> ContractfcsList_insert;
        ...
        /// </summary>
        [Display(Name = "合同上传文件列表")]
        public List<FileVM> ContractFileList_insert;
    }

    /// <summary>
    /// 合同更新模块
    /// </summary>
    public class MainContractUpdateDto
    {
        /// <summary>
        /// 描述 : UUID 
        /// 空值 : False
        ...
        /// 默认 : 
        /// </summary>
        [Display(Name = "合同体系项目列表(删除)")]
        public List<ContractItemVM> ContractItemList_delete;
        ...
        /// 默认 : 
        /// </summary>
        [Display(Name = "合同分场所信息(更新)")]
        public List<FcsVM> ContractfcsList_update;
        ...
        /// 默认 : 
        /// </summary>
        [Display(Name = "合同分场所信息(删除)")]
        public List<FcsVM> ContractfcsList_delete;
        ...
        /// 默认 : 
        /// </summary>
        [Display(Name = "合同上传文件列表(更新)")]
        public List<FileVM> ContractFileList_update;
        ...
        /// </summary>
        [Display(Name = "合同上传文件列表")]
        public List<FileVM> ContractFileList_delete;
    }
}
